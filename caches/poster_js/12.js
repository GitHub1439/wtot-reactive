...
if (isIE){
	if (document.readyState=="complete"){
		...
		document.onreadystatechange=function(){
			if(document.readyState=="complete") statAD('1', '14', '12');
		}
	}
} else {
	statAD('1', '14', '12');
...
if (isIE){
	if (document.readyState=="complete"){
		...
		document.onreadystatechange=function(){
			if(document.readyState=="complete") statAD('1', '13', '12');
		}
	}
} else {
	statAD('1', '13', '12');
...
if (isIE){
	if (document.readyState=="complete"){
		...
		document.onreadystatechange=function(){
			if(document.readyState=="complete") statAD('1', '12', '12');
		}
	}
} else {
	statAD('1', '12', '12');
...
imgs[1].src = "http://localhost/uploadfile/2016/1205/20161205113349835.jpg";
imgs[2].src = "http://localhost/uploadfile/2016/1205/20161205113321484.jpg";
imgs[3].src = "http://localhost/uploadfile/2016/1205/20161205113252993.jpg";
var tits = new Array();
tits[1] ="";
tits[2] ="";
tits[3] ="";
var imgwidth = 1920;//图片宽度
var imgheight = 555;//图片宽度
var str = "";
