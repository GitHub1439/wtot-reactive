...
(function() {
    ...
    var d = a.dom; (function() {
        ...
        a.tools = {
            ...
            convertRgbToHex: function(f) {
                return f.replace(/(?:rgb\(\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d+)\s*\))/gi,
                function(g, h, i, j) {
                    var k = [h, i, j];
            ...
            parseCssText: function(f, g, h) {
                ...
                if (!f || f == ';') return i;
                f.replace(/&quot;/g, '"').replace(/\s*([^:;\s]+)\s*:\s*([^;]+)\s*(?=;|$)/g,
                function(k, l, m) {
                    if (g) {
                        l = l.toLowerCase();
    ...
    h.clearMarkers = function(i, j, k) {
        ...
        e.extend(h.prototype, {
            ...
            removeAttributes: function(l) {
                if (e.isArray(l)) for (var m = 0; m < l.length; m++) this.removeAttribute(l[m]);
        ...
        function j(l) {
            ...
            for (var p = 0; p < m.length; p++) {
                if (n) for (var q = 0; q < n.length; q++) o.push([l, m[p], n[q]].join('-'));
        ...
        function k(l) {
            var m = 0;
            for (var n = 0,
            o = i[l].length; n < o; n++) m += parseInt(this.getComputedStyle(i[l][n]) || 0, 10) || 0;
            return m;
        };
    ...
    d.range = function(l) {
        ...
        m = function(v, w, x, y) {
            ...
            else if (A.getChildCount() > 0) if (C >= A.getChildCount()) {
        ...
        d.range.prototype = {
            ...
            setStart: function(v, w) {
                var x = this;
                if (v.type == 1 && f.$empty[v.getName()]) w = v.getIndex(),
                v = v.getParent();
                x.startContainer = v;
                x.startOffset = w;
                if (!x.endContainer) {
            ...
            setEnd: function(v, w) {
                var x = this;
                if (v.type == 1 && f.$empty[v.getName()]) w = v.getIndex() + 1,
                v = v.getParent();
                x.endContainer = v;
                x.endOffset = w;
                if (!x.startContainer) {
            ...
            checkReadOnly: (function() {
                function v(w, x) {
                    while (w) {
                        if (w.type == 1) if (w.getAttribute('contentEditable') == 'false' && !w.data('cke-editable')) return 0;
    ...
    function(m) {
        ...
        v = e.extend({},
        t.$block, t.$listItem, t.$tableContent);
        for (var w in v) {
        ...
        function Q(U) {
            return U.replace(/<!--(?!{cke_protected})[\s\S]+?-->/g,
            function(V) {
                return '<!--' + n + '{C}' + encodeURIComponent(V).replace(/--/g, '%2D%2D') + '-->';
            });
        };
        function R(U) {
            return U.replace(/<!--\{cke_protected\}\{C\}([\s\S]+?)-->/g,
            function(V, W) {
                return decodeURIComponent(W);
            });
        };
        ...
        function T(U, V) {
            ...
            for (var ab = 0; ab < aa.length; ab++) U = U.replace(aa[ab],
            function(ac) {
                ac = ac.replace(Z,
                function(ad, ae, af) {
                    return W[af];
            ...
            return U.replace(/(['"]).*?\1/g,
            function(ac) {
                return ac.replace(/<!--\{cke_protected\}([\s\S]+?)-->/g,
                function(ad, ae) {
    ...
    i.image_removeLinkByEmptyURL = true; (function() {
        ...
        function r(t, u) {
            return (u || t.getComputedStyle('direction')) == 'ltr' ? 'text-indent': 'margin-right';
        };
        function s(t) {
        ...
        q.prototype = {
            exec: function(t) {
                ...
                function x() {
                    ...
                    M.enlargeBr = N != 2;
                    var O;
                    while (O = M.getNextParagraph(N == 1 ? 'p': 'p')) y(O);
                };
                function y(M, N) {
                ...
                function(w) {
                    ...
                    while (z = y.next()) {
                        if (z.type == 1) {
                            ...
                            E = z.getStyle('text-indent');
                            D ? z.setStyle('text-indent', D) : z.removeStyle('text-indent');
    ...
    i.toolbarCanCollapse = true; (function() {
        ...
        function t(E) {
            ...
            I = I.replace(/\n/g, '<br>');
            if (! (H || c)) I = I.replace(new RegExp('<br>(?=</' + J + '>)'),
            function(O) {
                return e.repeat(O, 2);
            });
            if (b.gecko || b.webkit) {
            ...
            init: function(E) {
                ...
                function() {
                    ...
                    function W(X) {
                        ...
                        if (c && E.config.enterMode != 1) Y.on('selectionchange',
                        function() {
                            var ag = Y.getBody(),
                            ah = E.getSelection(),
                        ...
                        setTimeout(function() {
                            ...
                            if (E.config.disableObjectResizing) try {
                                ...
                                E.document.getBody().on(c ? 'resizestart': 'resize',
                                function(aj) {
                    ...
                    E.addMode('wysiwyg', {
                        ...
                        getData: function() {
                            ...
                            if (X.ignoreEmptyParagraph) ac = ac.replace(m,
                            function(ad, ae) {
                                return ae;
                            });
                            if (aa) ac = aa + '\n' + ac;
                    ...
                    function(X) {
                        ...
                        if (Y && !Y.isLocked) {
                            ...
                            D.call(this, X);
                            E.fire('updateSnapshot'); ! Z && E.resetDirty();
                        }
                    },
                    null, null, 1);
                });
    ...
    a.DIALOG_RESIZE_BOTH = 3; (function() {
        ...
        a.dialog.prototype = {
            ...
            addPage: function(R) {
                ...
                ad._.tabs[R.id] = [Z, W];
                ad._.tabIdList.push(R.id); ! R.hidden && ad._.pageCount++;
                ad._.lastTab = Z;
                ad.updateStyle();
        ...
        Q = function(R, S) {}; (function() {
            k.dialog = {
                uiElement: function(R, S, T, U, V, W, X) {
                    ...
                    Z.push('>', ac, '</', Y, '>');
                    T.push(Z.join('')); (this._ || (this._ = {})).dialog = R;
                    if (typeof S.isChanged == 'boolean') this.isChanged = function() {
                        return S.isChanged;
                    };
                    if (typeof S.isChanged == 'function') this.isChanged = S.isChanged;
                    if (typeof S.setValue == 'function') this.setValue = e.override(this.setValue,
                    function(am) {
                        return function(an) {
                            am.call(this, S.setValue.call(this, an));
                        };
                    });
                    if (typeof S.getValue == 'function') this.getValue = e.override(this.getValue,
                    function(am) {
                        return function() {
        ...
        k.dialog.uiElement.prototype = {
            ...
            setValue: function(R, S) {
                this.getInputElement().setValue(R); ! S && this.fire('change', {
                    value: R
                });
                return this;
            },
