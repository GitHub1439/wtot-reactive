...
var ZYFILE = {
		...
		funUploadFile : function(file){
			...
			//if($("#uploadTailor_"+file.index).length>0){
				...
				formdata.append("module", $("#module_"+file.index).attr("tailor"));
				formdata.append("catid",  $("#catid_"+file.index).attr("tailor"));
				formdata.append("userid", $("#userid_"+file.index).attr("tailor"));	
			//}
