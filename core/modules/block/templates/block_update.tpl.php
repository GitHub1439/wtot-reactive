...
<?php if ($data['type'] == 1) :?>
  <tr>
    <td class="y-bg"><textarea  style="width: 98%" id="data" name="data" rows="10"><?php echo new_html_special_chars($data['data'])?></textarea>

    <?php echo form::editor('data','desc','','','',1,0,'',320)?> 

</td>
  </tr>
<?php elseif ($data['type'] == 3):?>
  <tr>
    <td class="y-bg"><textarea  style="width: 98%" id="data" name="data" rows="10"><?php echo strip_tags($data['data'])?></textarea>
</td>
  </tr>
<?php else:?>
...
<?php echo L('datatable')?>: <input type="text" id="linenum" size="2" value="1" /><input type="button" value="<?php echo L('submit')?>" class="button" onclick="add_line()" />   
<div class="bk15"></div>
<div id="daima" style="display: none;">
<fieldset>
