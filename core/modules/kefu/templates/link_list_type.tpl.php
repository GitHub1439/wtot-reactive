...
?>
<div class="pad-lr-10">
<form name="myform" action="?m=kefu&c=kefu&a=delete_type" method="post" onsubmit="checkuid();return false;">
	...
	<tr>
		...
		<td align="center" width="12%"> <?php echo $info['typeid'];?></td>
		 <td align="center" width="20%"><a href="###"
			...
			href='?m=kefu&c=kefu&a=delete_type&typeid=<?php echo $info['typeid']?>'
...
function edit(id, name) {
	...
	window.top.art.dialog({title:'<?php echo L('edit')?> '+name+' ',id:'edit',iframe:'?m=kefu&c=kefu&a=edit_type&typeid='+id,width:'500',height:'300'}, function(){var d = window.top.art.dialog({id:'edit'}).data.iframe;var form = d.document.getElementById('dosubmit');form.click();return false;}, function(){window.top.art.dialog({id:'edit'}).close()});
}
function checkuid() {
	var ids='';
