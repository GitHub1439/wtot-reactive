...
<div class="pad_10">
<form action="?m=kefu&c=kefu&a=edit&linkid=<?php echo $linkid; ?>" method="post" name="myform" id="myform">
<table cellpadding="2" cellspacing="1" class="table_form" width="100%">
	...
	<tr>
		...
		<?php }elseif($linktype == 1){ ?>
			...
			<input type="radio" name="link[linktype]" value="2" style="border:0" onclick="$('#logolink').hide()" class="radio_style">
			<?php echo L('qq_link')?>&nbsp;&nbsp;&nbsp;&nbsp;
			<input type="radio" name="link[linktype]" value="0" style="border:0" onclick="$('#logolink').hide()" class="radio_style">
			<?php echo L('word_link')?>&nbsp;&nbsp;&nbsp;&nbsp;
...
<tr>
		<th></th>
		<td><input type="hidden" name="forward" value="?m=kefu&c=kefu&a=edit"> <input
