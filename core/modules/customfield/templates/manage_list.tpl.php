...
<table width="100%" cellspacing="0" id="listtable<?php echo $r['id'] ?>">
	...
	<thead>
		...
		<tr>
			...
			<th align="center"><?php echo '调用代码'; ?></th>
...
<?php foreach($filed_list[$r['id']] as $f){ ?>
	...
	<tr id="tr<?php echo $j ?>">
		...
		<td align="center">{php $allFields = customField()}<br>

{$allFields[$siteid]['<?php echo $f['name']?>']}</td>
...
<script type="text/javascript">
	...
	var trHtml   =	"<tr id='ntr" + addnum + "'>";
		...
		trHtml  +=	"<td align='center' style='width:200px' ></td>";
