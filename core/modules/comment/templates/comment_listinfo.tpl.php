...
<div class="table-list comment">
	...
	?>
     <tr id="tbody_<?php echo $v['id']?>">
		...
		<td align='center' width="72"><a href="?m=comment&c=comment_admin&a=del&ids=<?php echo $v['id']?>&tableid=<?php echo $tableid?>&dosubmit=1" onclick="return check(<?php echo $v['id']?>, -1, '<?php echo new_htmlentities($v['commentid']);?>')"><?php echo L('delete');?></a> </td>
	</tr>
     <?php }
	}
	?>
