...
<ul class="tabBut cu-li">
            ...
            <li id="tab_setting_6" onclick="SwapTab('setting','on','',6,6);"><?php echo '手机站设置';?></li>
</ul>
...
<!--
	...
	function load_file_list(id) {
		...
		$.getJSON('?m=admin&c=category&a=public_tpl_file_list_wap&style='+id+'&catid=<?php echo $parentid?>&type=1', function(data){$('#wap_page_template').html(data.page_template);});
	}
