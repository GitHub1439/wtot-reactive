...
['Source'],['Bold', 'Italic', '-', 'NumberedList', 'BulletedList', '-', 'Link', 'Unlink' ],['Maximize'],    //这是工具列表
		...
		<input type="text" name="info[catgory_lianjie]" id="catgory_lianjie" class="input-text" value="<?php echo $catgory_lianjie;?>" style="width:200px;">需要连接的栏目id，默认0连接到第一个子栏目
 ...
 <td  id="category_template">
	  ...
	  <tr>
	   ...
	   <tr>
        ...
        <td><input type='radio' name='info[is_category_index]' value='1' <?php if($is_category_index == 1) echo 'checked'; ?> > <?php echo L('yes');?>&nbsp;&nbsp;&nbsp;&nbsp;

          <input type='radio' name='info[is_category_index]' value='0' <?php if($is_category_index == 0) echo 'checked'; ?> > <?php echo L('no');?></td>
	  ...
	  <tr>
        ...
        <td><input type='radio' name='template_child' value='1' <?php if($template_child == 1) echo 'checked'; ?> > <?php echo L('yes');?>&nbsp;&nbsp;&nbsp;&nbsp;

          <input type='radio' name='template_child' value='0' <?php if($template_child == 0) echo 'checked'; ?> > <?php echo L('no');?></td>
...
<tr>
  ...
  <th width="200"><?php echo L('available_styles');?>：</th>
     ...
     <th><?php echo '是否在手机导航显示';?>：</th>
	  ...
	  <input type='radio' name='info[iswapmenu]' value='1' <?php if($iswapmenu) echo 'checked';?>> <?php echo L('yes');?>&nbsp;&nbsp;&nbsp;&nbsp;

	  <input type='radio' name='info[iswapmenu]' value='0' <?php if(!$iswapmenu) echo 'checked';?>> <?php echo L('no');?></td>
...
<!--
	...
	function load_file_list(id) {
		...
		$.getJSON('?m=admin&c=category&a=public_tpl_file_list_wap&style='+id+'&catid=<?php echo $catid?>', function(data){$('#wap_category_template').html(data.category_template);$('#wap_list_template').html(data.list_template);$('#wap_show_template').html(data.show_template);});
