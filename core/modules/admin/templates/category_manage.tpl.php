...
<div class="table-list">
    <table width="100%" cellspacing="0" >
        <thead>
            ...
            <th align='center' width="50">catid</th>
            <th ><?php echo L('catname');?></th>
            <th align='left' width='60'><?php echo L('category_type');?></th>
            <th align='left' width="60"><?php echo L('modelname');?></th>
            <th align='center' width="60"><?php echo L('items');?></th>
            <th align='center' width="60"><?php echo L('vistor');?></th>
            <th align='center' width="100"><?php echo L('domain_help');?></th>
			<th  align='center' width="280"><?php echo L('operations_manage');?></th>
            </tr>
        </thead>
    <tbody>
    <?php echo $categorys;?>
