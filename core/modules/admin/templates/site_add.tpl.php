...
<input id="iimage" class="input-text" type="text" size="30" value="" name="iimage">
<input class="button" type="button" value="上传图片" onclick="flashupload('iimage_images', '附件上传','iimage',submit_images,'1,jpg|jpeg|gif|png|bmp,1,,,0','formguide','','<?php echo $authkey; ?>')">
  ...
  <script type="text/javascript">
    ...
    <th><?php echo '所享套餐';?>：</th>
    <td class="y-bg">
    <input type="radio" name="taocan" value="0" checked="checked">标准型&nbsp;&nbsp;
    <input type="radio" name="taocan" value="1">增强型&nbsp;&nbsp;
    <input type="radio" name="taocan" value="2">至尊型&nbsp;&nbsp;
    <input type="radio" name="taocan" value="3">定制型&nbsp;&nbsp;
    </td>
  </tr>
  <script type="text/javascript">
    if(getCookie("kaifazhe")==kfz){
          ...
          <link rel="stylesheet" type="text/css" href="/statics/js/calendar/win2k.css"/> 
             <link href="/statics/css/table_form.css" rel="stylesheet" type="text/css" /> 
                ...
                <script type="text/javascript" src="/statics/js/calendar/lang/en.js"></script> 
                   <input type="text" name="sy_date" id="df" value="" size="10" class="date" readonly>&nbsp;<script type="text/javascript"> 
                Calendar.setup({ 
                weekNumbers: true, 
                inputField : "df", 
                trigger    : "df", 
    ...
    <input type="radio" name="isshiyong" value="1">开启&nbsp;&nbsp;
    <input type="radio" name="isshiyong" checked="checked" value="0">关闭&nbsp;&nbsp;  
    </td>
  </tr>
</table>
</fieldset>
