...
<table width="100%"  class="table_form">
  <tr>
    ...
    <td class="y-bg"><input type="text" class="input-text" name="old_attachment_path" id="old_attachment_path" size="40" value="localhost" /> <?php echo L('old_attachment_address_msg')?></td>
  </tr>
  <tr>
