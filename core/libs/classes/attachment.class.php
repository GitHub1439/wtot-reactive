...
class attachment {
	...
	function add($uploadedfile) {
		$this->att_db = pc_base::load_model('attachment_model');
		$uploadedfile['module'] = $uploadedfile['module'] ? $uploadedfile['module'] : $this->module ; 
		$uploadedfile['catid']  = $uploadedfile['catid'] ? $uploadedfile['catid'] : $this->catid ;  
		$uploadedfile['siteid'] = $this->siteid;
		$uploadedfile['userid'] = $uploadedfile['userid'] ? $uploadedfile['userid'] : $this->userid ; 
		$uploadedfile['uploadtime'] = SYS_TIME;
		$uploadedfile['uploadip'] = ip();
		$uploadedfile['status'] =  pc_base::load_config('system','attachment_stat')==0 ? 0 : 1;
